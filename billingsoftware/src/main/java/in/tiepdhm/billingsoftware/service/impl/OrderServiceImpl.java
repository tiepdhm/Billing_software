...
import in.tiepdhm.billingsoftware.io.*;
import in.tiepdhm.billingsoftware.repository.OrderEntityRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse verifyPayment(PaymentVerificationRequest request) {
        ...
        try {
            ...
            paymentDetails.setPaymentIntentId(request.getPaymentIntentId());
